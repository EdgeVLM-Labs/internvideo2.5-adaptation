...
echo "  - data/annotaions/qevd_fit_300k_train.jsonl (training split - InternVideo2.5 format)"
echo "  - data/annotaions/qevd_fit_300k_val.jsonl   (validation split - InternVideo2.5 format)"
echo "  - data/annotaions/qevd_fit_300k_test.jsonl  (test split - InternVideo2.5 format)"
